...
const materials = [
  ...
  },
  {
    ...
    topics: [
      'Konsep nested loop',
      'Pola segitiga & piramida',
      'Kombinasi IF dalam loop',
    ...
    <div className="space-y-6">
      ...
      <div className="text-center max-w-3xl mx-auto">
        ...
        <p className="text-gray-600 mb-6">
          Kuasai struktur kontrol percabangan (IF, ELSE, SWITCH) dan perulangan (FOR, WHILE, DO-WHILE) 
          dalam pemrograman terstruktur. Pelajari cara membuat keputusan dan iterasi yang efisien dalam kode.
        </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
        {materials.map((material) => {
          ...
          return (
            <div
              key={material.id}
              className={`bg-gradient-to-br ${material.gradient} rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all cursor-pointer hover:scale-[1.02]`}
                ...
                <div className="space-y-2">
                  ...
                  <div className="h-2 bg-white/20 rounded-full overflow-hidden">
                    <div 
                      ...
                      style={{ width: `${(material.completedModules / material.totalModules) * 100}%` }}
                    />
                  </div>
                </div>
              )}
      ...
      <Card className="bg-gradient-to-r from-blue-50 to-purple-50 border-blue-200">
        <div className="p-6">
          ...
          <p className="text-gray-600 text-sm mb-4">
            Untuk hasil maksimal, kerjakan materi secara berurutan dari Beginner ke Expert. 
            Selesaikan semua modul dalam satu materi sebelum melanjutkan ke materi berikutnya.
          </p>
